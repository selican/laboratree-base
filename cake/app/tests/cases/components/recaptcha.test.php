...
class RecaptchaComponentTestController extends AppController {
	var $name = 'Test';
	var $uses = array();
...
class RecaptchaTest extends CakeTestCase
{
	...
	function startTest()
	{
		$this->Controller = new RecaptchaComponentTestController();
		$this->Controller->constructClasses();
		$this->Controller->Component->initialize($this->Controller);
	}

	function testRecaptchaInstance() {
		$this->assertTrue(is_a($this->Controller->Recaptcha, 'RecaptchaComponent'));
	}
