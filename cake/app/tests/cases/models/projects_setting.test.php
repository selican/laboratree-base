<?php 
/* SVN FILE: $Id$ */
/* ProjectsSetting Test cases generated on: 2010-12-20 14:59:31 : 1292857171*/
App::import('Model', 'ProjectsSetting');

class ProjectsSettingTestCase extends CakeTestCase {
	var $ProjectsSetting = null;
	...
	function startTest() {
		$this->ProjectsSetting =& ClassRegistry::init('ProjectsSetting');
	}

	function testProjectsSettingInstance() {
		$this->assertTrue(is_a($this->ProjectsSetting, 'ProjectsSetting'));
	}

	function testProjectsSettingFind() {
		$this->ProjectsSetting->recursive = -1;
		$results = $this->ProjectsSetting->find('first');
		$this->assertTrue(!empty($results));

		$expected = array('ProjectsSetting' => array(
			'id'  => 1,
			'project_id'  => 1,
			'setting_id'  => 1,
			'value'  => 'true',
