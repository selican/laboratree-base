<?php 
/* SVN FILE: $Id$ */
/* Group Test cases generated on: 2010-12-20 14:56:15 : 1292856975*/
...
class GroupTestCase extends CakeTestCase {
	...
	function testToNode() {
		...
		$results = $this->Group->find('first');
		$node = $this->Group->toNode($results);
	...
	function testToNodeMissingModel() {
		try
		{
			$node = $this->Group->toNode(array('id' => 1));
			$this->fail('InvalidArgumentException was expected');
		}
		catch (InvalidArgumentException $e)
		{
	...
	function testToNodeMissingKey() {
		try
		{
			$node = $this->Group->toNode(array('Group' => array('test' => 1)));
			$this->fail('InvalidArgumentException was expected');
		}
		catch (InvalidArgumentException $e)
		{
