<?php 
/* SVN FILE: $Id$ */
/* GroupsSetting Test cases generated on: 2010-12-20 14:57:16 : 1292857036*/
App::import('Model', 'GroupsSetting');

class GroupsSettingTestCase extends CakeTestCase {
	var $GroupsSetting = null;
	...
	function startTest() {
		$this->GroupsSetting =& ClassRegistry::init('GroupsSetting');
	}

	function testGroupsSettingInstance() {
		$this->assertTrue(is_a($this->GroupsSetting, 'GroupsSetting'));
	}

	function testGroupsSettingFind() {
		$this->GroupsSetting->recursive = -1;
		$results = $this->GroupsSetting->find('first');
		$this->assertTrue(!empty($results));

		$expected = array('GroupsSetting' => array(
			'id'  => 1,
			'group_id'  => 1,
			'setting_id'  => 1,
			'value'  => 'Test'
