<?php
	...
	$html->addCrumb('Project Dashboard', '/help/projects/dashboard');
?>
...
<div class="help">
	<div class="helpText">
		...
		<p>Like the user dasboard, the project dashboard is main screen for managing a project in Laboratree. It allows you to see many of the same panles from your user dashboard, but only for one particular project. The panels can be collapsed, or rearranged to suit your needs here as well, and the positions will be remembered in your session cookie.</p>
		...
		<ol>
			...
			<li>
				Search
				<p>Allows you to search for any site content by name.  Results are displayed from all categories with matches (documents, notes, users, projects, etc.)</p></li>
			<li>
				Panel Buttons
			...
			<li>
				Panel Links
				<p>Many of the fields in panels are links to other areas of the site.  For example, clicking the name of a note in your notes panel will take you to that note detail page.</p>
				<br />
				<p><b>If you are a project manager, or have been granted permission, you will see additional functionality in the action bar.  For example, a link to manage the project members.</b></p>
			</li>
			<li>
				Main Navigation
