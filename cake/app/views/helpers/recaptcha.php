...
class RecaptchaHelper extends AppHelper {
	...
	{
		$data = $this->__form(Configure::read("Recaptcha.public_key"), $error, $use_ssl);
	...
	{
		$data = $this->recaptcha_mailhide_html(Configure::read('Recaptcha.public_key'), Configure::read('Recaptcha.private_key'), $email);
		if($output_method == "echo")
			echo $data;
		else
			return $data;
